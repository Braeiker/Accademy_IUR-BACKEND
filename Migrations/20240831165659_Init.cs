        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniAdministratorId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_AspNetUsers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_AspNetUsers_UniAdministratorId",
                        column: x => x.UniAdministratorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserRoles_StudentId",
                table: "AspNetUserRoles",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserRoles_TeacherId",
                table: "AspNetUserRoles",
                column: "TeacherId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserRoles_UniAdministratorId",
                table: "AspNetUserRoles",
                column: "UniAdministratorId");
